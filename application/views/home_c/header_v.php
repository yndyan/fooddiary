...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
        <a class="navbar-brand" href="<?php echo $base_url_index?>/diary_c/add_food"> Food diary</a>
    </div>
    ...
    <div>
        ...
        <ul class="nav navbar-nav navbar-right">
           <?php if($userStatus=== Users_m::USER_STATUS_NOT_VERIFIED){
            ...
            <li><a href = "<?php echo $base_url_index?>/user_c/display_user_data"><span class="glyphicon glyphicon-user"></span> <?php echo $username; ?></a></li>
