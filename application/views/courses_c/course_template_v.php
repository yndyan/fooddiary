<li id= "course_id_<?php echo $course_id?>" class="course list-group-item col-sm-12 cm_fake_label">
		<div class = 'clearfix'>
			<div class="col-sm-6 ">
	    ...
	    <div class="buttons pull-right"> 
	        ...
	        <a href="<?php echo base_url();?>index.php/courses_c/delete_course?course_id=<?php echo $course_id?>" class="confirm_delete btn btn-danger "><span class="glyphicon glyphicon-trash"></span> Delete</a>
