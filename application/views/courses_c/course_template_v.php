<li id= "course_id_<?php echo $course_id?>" class="course list-group-item col-sm-12">
    ...
    <div class="coursename well well-sm col-sm-6 "><?php  echo $coursename;?> </div>
            
    <div class="buttons pull-right"> 
        <a href="<?php echo base_url();?>index.php/courses_c/show_update_course?course_id=<?php echo $course_id?>" class=" btn btn-success "><span class="glyphicon glyphicon-edit"></span> Edit</a>
